...
void ImuInit()
{
    ...
    iicTrans.writeBuf = imuInitSeq1;//imuInitSeq0;
    iicTrans.writeCount = 2;//5;
    ...
    iicTrans.writeBuf = imuInitSeq0;//imuInitSeq1;
    iicTrans.writeCount = 5;//2;
